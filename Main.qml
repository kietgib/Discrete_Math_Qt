...
ApplicationWindow {
    ...
    // Row chính bao toàn màn hình (cột trái + khung trắng)
    Row {
        anchors.fill: parent
        spacing: 50
        anchors.margins: 20
        ...
        Column {
            ...
            // 🧭 Header chuyển thành Row ngay đầu cột trái
            Row {
                spacing: 12
                Image {
                ...
                Column {
                    ...
                    Text {
                        ...
                        font.pointSize: 8; font.bold: true; color: "#D3D3D3"
                    }
                    Text {
            ...
            Text { text: "CHOSEN SUBJECTS:"; color: "yellow"; font.bold: true; font.pointSize: 11 }
